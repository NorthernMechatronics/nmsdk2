...
static const hciEvtParse_t hciEvtParseFcnTbl[] = {
    NULL,                                   //  0 HCI_RESET_SEQ_CMPL_CBACK_EVT
    hciEvtParseLeConnCmpl,                  //  1 HCI_LE_CONN_CMPL_CBACK_EVT
    hciEvtParseLeEnhancedConnCmpl,          //  2 HCI_LE_ENHANCED_CONN_CMPL_CBACK_EVT
    hciEvtParseDisconnectCmpl,              //  3 HCI_DISCONNECT_CMPL_CBACK_EVT
    hciEvtParseLeConnUpdateCmpl,            //  4 HCI_LE_CONN_UPDATE_CMPL_CBACK_EVT
    hciEvtParseLeCreateConnCancelCmdCmpl,   //  5 HCI_LE_CREATE_CONN_CANCEL_CMD_CMPL_CBACK_EVT
    NULL,                                   //  6 HCI_LE_ADV_REPORT_CBACK_EVT
    hciEvtParseReadRssiCmdCmpl,             //  7 HCI_READ_RSSI_CMD_CMPL_CBACK_EVT
    hciEvtParseReadChanMapCmdCmpl,          //  8 HCI_LE_READ_CHAN_MAP_CMPL_CBACK_EVT
    hciEvtParseReadTxPwrLvlCmdCmpl,         //  9 HCI_READ_TX_PWR_LVL_CMD_CMPL_CBACK_EVT
    hciEvtParseReadRemoteVerInfoCmpl,       // 10 HCI_READ_REMOTE_VER_INFO_CMPL_CBACK_EVT
    hciEvtParseReadLeRemoteFeatCmpl,        // 11 HCI_LE_READ_REMOTE_FEAT_CMPL_CBACK_EVT
    hciEvtParseLeLtkReqReplCmdCmpl,         // 12 HCI_LE_LTK_REQ_REPL_CMD_CMPL_CBACK_EVT
    hciEvtParseLeLtkReqNegReplCmdCmpl,      // 13 HCI_LE_LTK_REQ_NEG_REPL_CMD_CMPL_CBACK_EVT
    hciEvtParseEncKeyRefreshCmpl,           // 14 HCI_ENC_KEY_REFRESH_CMPL_CBACK_EVT
    hciEvtParseEncChange,                   // 15 HCI_ENC_CHANGE_CBACK_EVT
    hciEvtParseLeLtkReq,                    // 16 HCI_LE_LTK_REQ_CBACK_EVT
    hciEvtParseVendorSpecCmdStatus,         // 17 HCI_VENDOR_SPEC_CMD_STATUS_CBACK_EVT
    hciEvtParseVendorSpecCmdCmpl,           // 18 HCI_VENDOR_SPEC_CMD_CMPL_CBACK_EVT
    hciEvtParseVendorSpec,                  // 19 HCI_VENDOR_SPEC_CBACK_EVT
    hciEvtParseHwError,                     // 20 HCI_HW_ERROR_CBACK_EVT
    hciEvtParseLeAddDevToResListCmdCmpl,    // 21 HCI_LE_ADD_DEV_TO_RES_LIST_CMD_CMPL_CBACK_EVT
    hciEvtParseLeRemDevFromResListCmdCmpl,  // 22 HCI_LE_REM_DEV_FROM_RES_LIST_CMD_CMPL_CBACK_EVT
    hciEvtParseLeClearResListCmdCmpl,       // 23 HCI_LE_CLEAR_RES_LIST_CMD_CMPL_CBACK_EVT
    hciEvtParseLeReadPeerResAddrCmdCmpl,    // 24 HCI_LE_READ_PEER_RES_ADDR_CMD_CMPL_CBACK_EVT
    hciEvtParseLeReadLocalResAddrCmdCmpl,   // 25 HCI_LE_READ_LOCAL_RES_ADDR_CMD_CMPL_CBACK_EVT
    hciEvtParseLeSetAddrResEnableCmdCmpl,   // 26 HCI_LE_SET_ADDR_RES_ENABLE_CMD_CMPL_CBACK_EVT
    hciEvtParseLeEncryptCmdCmpl,            // 27 HCI_LE_ENCRYPT_CMD_CMPL_CBACK_EVT
    hciEvtParseLeRandCmdCmpl,               // 28 HCI_LE_RAND_CMD_CMPL_CBACK_EVT
    hciEvtParseRemConnParamRepCmdCmpl,      // 29 HCI_LE_REM_CONN_PARAM_REP_CMD_CMPL_CBACK_EVT
    hciEvtParseRemConnParamNegRepCmdCmpl,   // 30 HCI_LE_REM_CONN_PARAM_NEG_REP_CMD_CMPL_CBACK_EVT
    hciEvtParseReadDefDataLenCmdCmpl,       // 31 HCI_LE_READ_DEF_DATA_LEN_CMD_CMPL_CBACK_EVT
    hciEvtParseWriteDefDataLenCmdCmpl,      // 32 HCI_LE_WRITE_DEF_DATA_LEN_CMD_CMPL_CBACK_EVT
    hciEvtParseSetDataLenCmdCmpl,           // 33 HCI_LE_SET_DATA_LEN_CMD_CMPL_CBACK_EVT
    hciEvtParseReadMaxDataLenCmdCmpl,       // 34 HCI_LE_READ_MAX_DATA_LEN_CMD_CMPL_CBACK_EVT
    hciEvtParseRemConnParamReq,             // 35 HCI_LE_REM_CONN_PARAM_REQ_CBACK_EVT
    hciEvtParseDataLenChange,               // 36 HCI_LE_DATA_LEN_CHANGE_CBACK_EVT
    hciEvtParseReadPubKeyCmdCmpl,           // 37 HCI_LE_READ_LOCAL_P256_PUB_KEY_CMPL_CBACK_EVT
    hciEvtParseGenDhKeyCmdCmpl,             // 38 HCI_LE_GENERATE_DHKEY_CMPL_CBACK_EVT
    hciEvtParseWriteAuthTimeoutCmdCmpl,     // 39 HCI_WRITE_AUTH_PAYLOAD_TO_CMD_CMPL_CBACK_EVT
    hciEvtParseAuthTimeoutExpiredEvt,       // 40 HCI_AUTH_PAYLOAD_TO_EXPIRED_CBACK_EVT
    hciEvtParseReadPhyCmdCmpl,              // 41 HCI_LE_READ_PHY_CMD_CMPL_CBACK_EVT
    hciEvtParseSetDefPhyCmdCmpl,            // 42 HCI_LE_SET_DEF_PHY_CMD_CMPL_CBACK_EVT
    hciEvtParsePhyUpdateCmpl,               // 43 HCI_LE_PHY_UPDATE_CMPL_CBACK_EVT
    NULL,                                   // 44 HCI_LE_EXT_ADV_REPORT_CBACK_EVT
    hciEvtParseLeScanTimeout,               // 45 HCI_LE_SCAN_TIMEOUT_CBACK_EVT
    hciEvtParseLeAdvSetTerm,                // 46 HCI_LE_ADV_SET_TERM_CBACK_EVT
    hciEvtParseLeScanReqRcvd,               // 47 HCI_LE_SCAN_REQ_RCVD_CBACK_EVT
    hciEvtParseLePerAdvSyncEst,             // 48 HCI_LE_PER_ADV_SYNC_EST_CBACK_EVT
    NULL,                                   // 49 HCI_LE_PER_ADV_REPORT_CBACK_EVT
    hciEvtParseLePerAdvSyncLost,            // 50 HCI_LE_PER_ADV_SYNC_LOST_CBACK_EVT
    hciEvtParseLeChSelAlgo,                 // 51 HCI_LE_CH_SEL_ALGO_CBACK_EVT
    hciEvtParseLeCmdCmpl,                   // 52 HCI_LE_SCAN_ENABLE_CMD_CMPL_CBACK_EVT
    hciEvtParseLeCmdCmpl,                   // 53 HCI_LE_ADV_ENABLE_CMD_CMPL_CBACK_EVT
    hciEvtParseLeCmdCmpl,                   // 54 HCI_LE_EXT_SCAN_ENABLE_CMD_CMPL_CBACK_EVT
    hciEvtParseLeCmdCmpl,                   // 55 HCI_LE_EXT_ADV_ENABLE_CMD_CMPL_CBACK_EVT
    hciEvtParseLeCmdCmpl,                   // 56 HCI_LE_PER_ADV_ENABLE_CMD_CMPL_CBACK_EVT
    hciEvtParseLeCmdCmpl,                   // 57 HCI_LE_SET_RAND_ADDR_CMD_CMPL_CBACK_EVT
    hciEvtParseLePerSyncTrsfRcvd,           // 58 HCI_LE_PER_SYNC_TRSF_RCVD_CBACK_EVT
    hciEvtParseLePerAdvSyncTrsfCmdCmpl,     // 59 HCI_LE_PER_ADV_SYNC_TRSF_CMD_CMPL_CBACK_EVT
    hciEvtParseLePerAdvSetInfoTrsfCmdCmpl,  // 60 HCI_LE_PER_ADV_SET_INFO_TRSF_CMD_CMPL_CBACK_EVT
    NULL,                                   // 61 HCI_LE_CONN_IQ_REPORT_CBACK_EVT
    hciEvtParseLeCteReqFailed,              // 62 HCI_LE_CTE_REQ_FAILED_CBACK_EVT
    hciEvtParseLeSetConnCteRcvParm,         // 63 HCI_LE_SET_CONN_CTE_RX_PARAMS_CMD_CMPL_CBACK_EVT
    hciEvtParseLeSetConnCteTxParm,          // 64 HCI_LE_SET_CONN_CTE_TX_PARAMS_CMD_CMPL_CBACK_EVT
    hciEvtParseLeConnCteReqEn,              // 65 HCI_LE_CONN_CTE_REQ_ENABLE_CMD_CMPL_CBACK_EVT
    hciEvtParseLeConnCteRspEn,              // 66 HCI_LE_CONN_CTE_RSP_ENABLE_CMD_CMPL_CBACK_EVT
    hciEvtParseLeReadAntennaInfoCmdCmpl,    // 67 HCI_LE_READ_ANTENNA_INFO_CMD_CMPL_CBACK_EVT
    hciEvtParseLeCisEst,                    // 68 HCI_LE_CIS_EST_CBACK_EVT
    hciEvtParseLeCisReq,                    // 69 HCI_LE_CIS_REQ_CBACK_EVT
    hciEvtParseDisconnectCmpl,              // 70 HCI_CIS_DISCONNECT_CMPL_CBACK_EVT
    hciEvtParseLeReqPeerScaCmpl,            // 71 HCI_LE_REQ_PEER_SCA_CBACK_EVT
    hciEvtParseLeSetCigParamsCmdCmpl,       // 72 HCI_LE_SET_CIG_PARAMS_CMD_CMPL_CBACK_EVT
    hciEvtParseLeRemoveCigCmdCmpl,          // 73 HCI_LE_REMOVE_CIG_CMD_CMPL_CBACK_EVT
    hciEvtParseLeSetupIsoDataPathCmdCmpl,   // 74 HCI_LE_SETUP_ISO_DATA_PATH_CMD_CMPL_CBACK_EVT
    hciEvtParseLeRemoveIsoDataPathCmdCmpl,  // 75 HCI_LE_REMOVE_ISO_DATA_PATH_CMD_CMPL_CBACK_EVT
    hciEvtParseConfigDataPathCmdCmpl,       // 76 HCI_CONFIG_DATA_PATH_CMD_CMPL_CBACK_EVT
    hciEvtParseReadLocalSupCodecsCmdCmpl,   // 77 HCI_READ_LOCAL_SUP_CODECS_CMD_CMPL_CBACK_EVT
    hciEvtParseReadLocalSupCodecCapCmdCmpl, // 78 HCI_READ_LOCAL_SUP_CODEC_CAP_CMD_CMPL_CBACK_EVT
    hciEvtParseReadLocalSupCtrDlyCmdCmpl,   // 79 HCI_READ_LOCAL_SUP_CTR_DLY_CMD_CMPL_CBACK_EVT
    hciEvtParseLeCreateBigCmpl,             // 80 HCI_LE_CREATE_BIG_CMPL_CBACK_EVT
    hciEvtParseLeTerminateBigCmpl,          // 81 HCI_LE_TERM_BIG_CMPL_CBACK_EVT
    hciEvtParseLeBigSyncEst,                // 82 HCI_LE_BIG_SYNC_EST_CBACK_EVT
...
static const uint8_t hciEvtCbackLen[] = {
    sizeof(wsfMsgHdr_t),                         //  0 HCI_RESET_SEQ_CMPL_CBACK_EVT
    sizeof(hciLeConnCmplEvt_t),                  //  1 HCI_LE_CONN_CMPL_CBACK_EVT
    sizeof(hciLeConnCmplEvt_t),                  //  2 HCI_LE_ENHANCED_CONN_CMPL_CBACK_EVT
    sizeof(hciDisconnectCmplEvt_t),              //  3 HCI_DISCONNECT_CMPL_CBACK_EVT
    sizeof(hciLeConnUpdateCmplEvt_t),            //  4 HCI_LE_CONN_UPDATE_CMPL_CBACK_EVT
    sizeof(hciLeCreateConnCancelCmdCmplEvt_t),   //  5 HCI_LE_CREATE_CONN_CANCEL_CMD_CMPL_CBACK_EVT
    sizeof(hciLeAdvReportEvt_t),                 //  6 HCI_LE_ADV_REPORT_CBACK_EVT
    sizeof(hciReadRssiCmdCmplEvt_t),             //  7 HCI_READ_RSSI_CMD_CMPL_CBACK_EVT
    sizeof(hciReadChanMapCmdCmplEvt_t),          //  8 HCI_LE_READ_CHAN_MAP_CMD_CMPL_CBACK_EVT
    sizeof(hciReadTxPwrLvlCmdCmplEvt_t),         //  9 HCI_READ_TX_PWR_LVL_CMD_CMPL_CBACK_EVT
    sizeof(hciReadRemoteVerInfoCmplEvt_t),       // 10 HCI_READ_REMOTE_VER_INFO_CMPL_CBACK_EVT
    sizeof(hciLeReadRemoteFeatCmplEvt_t),        // 11 HCI_LE_READ_REMOTE_FEAT_CMPL_CBACK_EVT
    sizeof(hciLeLtkReqReplCmdCmplEvt_t),         // 12 HCI_LE_LTK_REQ_REPL_CMD_CMPL_CBACK_EVT
    sizeof(hciLeLtkReqNegReplCmdCmplEvt_t),      // 13 HCI_LE_LTK_REQ_NEG_REPL_CMD_CMPL_CBACK_EVT
    sizeof(hciEncKeyRefreshCmpl_t),              // 14 HCI_ENC_KEY_REFRESH_CMPL_CBACK_EVT
    sizeof(hciEncChangeEvt_t),                   // 15 HCI_ENC_CHANGE_CBACK_EVT
    sizeof(hciLeLtkReqEvt_t),                    // 16 HCI_LE_LTK_REQ_CBACK_EVT
    sizeof(hciVendorSpecCmdStatusEvt_t),         // 17 HCI_VENDOR_SPEC_CMD_STATUS_CBACK_EVT
    sizeof(hciVendorSpecCmdCmplEvt_t),           // 18 HCI_VENDOR_SPEC_CMD_CMPL_CBACK_EVT
    sizeof(hciVendorSpecEvt_t),                  // 19 HCI_VENDOR_SPEC_CBACK_EVT
    sizeof(hciHwErrorEvt_t),                     // 20 HCI_HW_ERROR_CBACK_EVT
    sizeof(hciLeAddDevToResListCmdCmplEvt_t),    // 21 HCI_LE_ADD_DEV_TO_RES_LIST_CMD_CMPL_CBACK_EVT
    sizeof(hciLeRemDevFromResListCmdCmplEvt_t),  // 22 HCI_LE_REM_DEV_FROM_RES_LIST_CMD_CMPL_CBACK_EVT
    sizeof(hciLeClearResListCmdCmplEvt_t),       // 23 HCI_LE_CLEAR_RES_LIST_CMD_CMPL_CBACK_EVT
    sizeof(hciLeReadPeerResAddrCmdCmplEvt_t),    // 24 HCI_LE_READ_PEER_RES_ADDR_CMD_CMPL_CBACK_EVT
    sizeof(hciLeReadLocalResAddrCmdCmplEvt_t),   // 25 HCI_LE_READ_LOCAL_RES_ADDR_CMD_CMPL_CBACK_EVT
    sizeof(hciLeSetAddrResEnableCmdCmplEvt_t),   // 26 HCI_LE_SET_ADDR_RES_ENABLE_CMD_CMPL_CBACK_EVT
    sizeof(hciLeEncryptCmdCmplEvt_t),            // 27 HCI_LE_ENCRYPT_CMD_CMPL_CBACK_EVT
    sizeof(hciLeRandCmdCmplEvt_t),               // 28 HCI_LE_RAND_CMD_CMPL_CBACK_EVT
    sizeof(hciLeRemConnParamRepEvt_t),           // 29 HCI_LE_REM_CONN_PARAM_REP_CMD_CMPL_CBACK_EVT
    sizeof(hciLeRemConnParamNegRepEvt_t),        // 30 HCI_LE_REM_CONN_PARAM_NEG_REP_CMD_CMPL_CBACK_EVT
    sizeof(hciLeReadDefDataLenEvt_t),            // 31 HCI_LE_READ_DEF_DATA_LEN_CMD_CMPL_CBACK_EVT
    sizeof(hciLeWriteDefDataLenEvt_t),           // 32 HCI_LE_WRITE_DEF_DATA_LEN_CMD_CMPL_CBACK_EVT
    sizeof(hciLeSetDataLenEvt_t),                // 33 HCI_LE_SET_DATA_LEN_CMD_CMPL_CBACK_EVT
    sizeof(hciLeReadMaxDataLenEvt_t),            // 34 HCI_LE_READ_MAX_DATA_LEN_CMD_CMPL_CBACK_EVT
    sizeof(hciLeRemConnParamReqEvt_t),           // 35 HCI_LE_REM_CONN_PARAM_REQ_CBACK_EVT
    sizeof(hciLeDataLenChangeEvt_t),             // 36 HCI_LE_DATA_LEN_CHANGE_CBACK_EVT
    sizeof(hciLeP256CmplEvt_t),                  // 37 HCI_LE_READ_LOCAL_P256_PUB_KEY_CMPL_CBACK_EVT
    sizeof(hciLeGenDhKeyEvt_t),                  // 38 HCI_LE_GENERATE_DHKEY_CMPL_CBACK_EVT
    sizeof(hciWriteAuthPayloadToCmdCmplEvt_t),   // 39 HCI_WRITE_AUTH_PAYLOAD_TO_CMD_CMPL_CBACK_EVT
    sizeof(hciAuthPayloadToExpiredEvt_t),        // 40 HCI_AUTH_PAYLOAD_TO_EXPIRED_CBACK_EVT
    sizeof(hciLeReadPhyCmdCmplEvt_t),            // 41 HCI_LE_READ_PHY_CMD_CMPL_CBACK_EVT
    sizeof(hciLeSetDefPhyCmdCmplEvt_t),          // 42 HCI_LE_SET_DEF_PHY_CMD_CMPL_CBACK_EVT
    sizeof(hciLePhyUpdateEvt_t),                 // 43 HCI_LE_PHY_UPDATE_CMPL_CBACK_EVT
    sizeof(hciLeExtAdvReportEvt_t),              // 44 HCI_LE_EXT_ADV_REPORT_CBACK_EVT
    sizeof(hciLeScanTimeoutEvt_t),               // 45 HCI_LE_SCAN_TIMEOUT_CBACK_EVT
    sizeof(hciLeAdvSetTermEvt_t),                // 46 HCI_LE_ADV_SET_TERM_CBACK_EVT
    sizeof(hciLeScanReqRcvdEvt_t),               // 47 HCI_LE_SCAN_REQ_RCVD_CBACK_EVT
    sizeof(hciLePerAdvSyncEstEvt_t),             // 48 HCI_LE_PER_ADV_SYNC_EST_CBACK_EVT
    sizeof(hciLePerAdvReportEvt_t),              // 49 HCI_LE_PER_ADV_REPORT_CBACK_EVT
    sizeof(hciLePerAdvSyncLostEvt_t),            // 50 HCI_LE_PER_ADV_SYNC_LOST_CBACK_EVT
    sizeof(hciLeChSelAlgoEvt_t),                 // 51 HCI_LE_CH_SEL_ALGO_CBACK_EVT
    sizeof(wsfMsgHdr_t),                         // 52 HCI_LE_SCAN_ENABLE_CMD_CMPL_CBACK_EVT
    sizeof(wsfMsgHdr_t),                         // 53 HCI_LE_ADV_ENABLE_CMD_CMPL_CBACK_EVT
    sizeof(wsfMsgHdr_t),                         // 54 HCI_LE_EXT_SCAN_ENABLE_CMD_CMPL_CBACK_EVT
    sizeof(wsfMsgHdr_t),                         // 55 HCI_LE_EXT_ADV_ENABLE_CMD_CMPL_CBACK_EVT
    sizeof(wsfMsgHdr_t),                         // 56 HCI_LE_PER_ADV_ENABLE_CMD_CMPL_CBACK_EVT
    sizeof(wsfMsgHdr_t),                         // 57 HCI_LE_SET_RAND_ADDR_CMD_CMPL_CBACK_EVT
    sizeof(HciLePerAdvSyncTrsfRcvdEvt_t),        // 58 HCI_LE_PER_SYNC_TRSF_RCVD_CBACK_EVT
    sizeof(hciLePerAdvSyncTrsfCmdCmplEvt_t),     // 59 HCI_LE_PER_ADV_SYNC_TRSF_CMD_CMPL_CBACK_EVT
    sizeof(hciLePerAdvSetInfoTrsfCmdCmplEvt_t),  // 60 HCI_LE_PER_ADV_SET_INFO_TRSF_CMD_CMPL_CBACK_EVT
    sizeof(hciLeConnIQReportEvt_t),              // 61 HCI_LE_CONN_IQ_REPORT_CBACK_EVT
    sizeof(hciLeCteReqFailedEvt_t),              // 62 HCI_LE_CTE_REQ_FAILED_CBACK_EVT
    sizeof(hciLeSetConnCteRxParamsCmdCmplEvt_t), // 63 HCI_LE_SET_CONN_CTE_RX_PARAMS_CMD_CMPL_CBACK_EVT
    sizeof(hciLeSetConnCteTxParamsCmdCmplEvt_t), // 64 HCI_LE_SET_CONN_CTE_TX_PARAMS_CMD_CMPL_CBACK_EVT
    sizeof(hciLeConnCteReqEnableCmdCmplEvt_t),   // 65 HCI_LE_CONN_CTE_REQ_ENABLE_CMD_CMPL_CBACK_EVT
    sizeof(hciLeConnCteRspEnableCmdCmplEvt_t),   // 66 HCI_LE_CONN_CTE_RSP_ENABLE_CMD_CMPL_CBACK_EVT
    sizeof(hciLeReadAntennaInfoCmdCmplEvt_t),    // 67 HCI_LE_READ_ANTENNA_INFO_CMD_CMPL_CBACK_EVT
    sizeof(HciLeCisEstEvt_t),                    // 68 HCI_LE_CIS_EST_CBACK_EVT
    sizeof(HciLeCisReqEvt_t),                    // 69 HCI_LE_CIS_REQ_CBACK_EVT
    sizeof(hciDisconnectCmplEvt_t),              // 70 HCI_CIS_DISCONNECT_CMPL_CBACK_EVT
    sizeof(HciLeReqPeerScaCmplEvt_t_t),          // 71 HCI_LE_REQ_PEER_SCA_CBACK_EVT
    sizeof(hciLeSetCigParamsCmdCmplEvt_t),       // 72 HCI_LE_SET_CIG_PARAMS_CMD_CMPL_CBACK_EVT
    sizeof(hciLeRemoveCigCmdCmplEvt_t),          // 73 HCI_LE_REMOVE_CIG_CMD_CMPL_CBACK_EVT
    sizeof(hciLeSetupIsoDataPathCmdCmplEvt_t),   // 74 HCI_LE_SETUP_ISO_DATA_PATH_CMD_CMPL_CBACK_EVT
    sizeof(hciLeRemoveIsoDataPathCmdCmplEvt_t),  // 75 HCI_LE_REMOVE_ISO_DATA_PATH_CMD_CMPL_CBACK_EVT
    sizeof(hciConfigDataPathCmdCmplEvt_t),       // 76 HCI_CONFIG_DATA_PATH_CMD_CMPL_CBACK_EVT
    sizeof(hciReadLocalSupCodecsCmdCmplEvt_t),   // 77 HCI_READ_LOCAL_SUP_CODECS_CMD_CMPL_CBACK_EVT
    sizeof(hciReadLocalSupCodecCapCmdCmplEvt_t), // 78 HCI_READ_LOCAL_SUP_CODEC_CAP_CMD_CMPL_CBACK_EVT
    sizeof(hciReadLocalSupCtrDlyCmdCmplEvt_t),   // 79 HCI_READ_LOCAL_SUP_CTR_DLY_CMD_CMPL_CBACK_EVT
    sizeof(HciLeCreateBigCmplEvt_t),             // 80 HCI_LE_CREATE_BIG_CMPL_CBACK_EVT
    sizeof(HciLeTerminateBigCmplEvt_t),          // 81 HCI_LE_TERM_BIG_CMPL_CBACK_EVT
    sizeof(HciLeBigSyncEstEvt_t),                // 82 HCI_LE_BIG_SYNC_EST_CBACK_EVT
...
static void hciEvtProcessLeConlessIQReport(uint8_t *p, uint8_t len)
{
    ...
    if ((pMsg = WsfBufAlloc(sizeof(hciLeConlessIQReportEvt_t) + HCI_IQ_RPT_SAMPLE_CNT_MAX * 2)) !=
        NULL)
    {
...
static void hciEvtParseReadLocalSupCodecCapCmdCmpl(hciEvt_t *pMsg, uint8_t *p, uint8_t len)
{
    ...
    for (uint8_t i = 0; i < pMsg->readLocalSupCodecCapCmdCmpl.numCodecCaps; i++)
    {
        ...
        memcpy(pMsg->readLocalSupCodecCapCmdCmpl.codecCap[i].data,
               p,
               pMsg->readLocalSupCodecCapCmdCmpl.codecCap[i].len);
        p += dataLen;
...
void hciEvtProcessMsg(uint8_t *pEvt)
{
    ...
    case HCI_DISCONNECT_CMPL_EVT:
        ...
        /*
      // FIXME: hci_api.h conflicting definition line 122
      BYTES_TO_UINT16(handle, (pEvt + 1));
