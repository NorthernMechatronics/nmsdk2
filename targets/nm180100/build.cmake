...
set(COMMON_C_FLAGS              "-Werror -Wdouble-promotion -Wmissing-field-initializers -Wshadow -Wstrict-aliasing -Wswitch -mthumb -fdata-sections -ffunction-sections -mcpu=cortex-m4 -mfpu=fpv4-sp-d16 -mfloat-abi=hard")

set(CMAKE_C_FLAGS               "${COMMON_C_FLAGS} -std=c11 -Wimplicit-function-declaration")
set(CMAKE_CXX_FLAGS             "${COMMON_C_FLAGS} -std=c++17 -fno-exceptions -fno-rtti")
